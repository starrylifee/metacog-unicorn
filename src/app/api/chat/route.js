...
[FEEDBACK:X점을 준 이유를 학생이 실제로 한 말과 연결해서 구체적으로 설명해. 반드시 학생이 대화 중 실제로 한 말 한 구절을 큰따옴표로 인용하고, 그게 왜 좋았는지 또는 왜 아쉬웠는지 짚어 줘. 막연하게 "근거가 부족했어"라고만 하지 말고, 학생이 한 말 중 어느 부분이 짐작에 그쳤는지 또는 어떤 좋은 관찰을 더 살렸어야 했는지 구체적으로 말해. 예: "네가 '어둡고 신나고 떨리는 모습'이라고 한 건 정말 좋은 관찰이었어. 그런데 마지막에 '노력해서 잘 그린 것 같다'고 한 건 그림을 본 근거라기보다 네 짐작에 가까워서, 그 좋은 관찰을 판단까지 이어가지 못한 게 조금 아쉬웠어."]
[NEXT_STEP_TIP:최고점이 아니라면, 학생이 "이렇게 말했으면 더 높은 점수를 받았을 거야" 형식으로 모범 예시 문장을 큰따옴표 안에 1개 제시해. 그 예시 문장은 가능하면 학생이 대화 중 이미 말한 좋은 관찰을 재활용해서 만들어. 그리고 그렇게 말했다면 몇 점을 받을 수 있었는지 점수도 함께 알려 줘(반드시 ${formatScoreOptions(scoreOptions)}점 중 현재 점수보다 높은 점수 하나). 예: "네가 본 '어두운 색'과 '신나고 떨리는 느낌'을 이렇게 연결했으면 좋았어: '자이로드롭 배경을 어두운 회색으로 칠해서 무서운 느낌이 나는데, 타는 친구들은 신나 보여서 무섭지만 재밌는 마음이 다 느껴져서 잘 그린 것 같아요.' 이렇게 색과 느낌을 근거로 판단했으면 ${maxScore}점도 받을 수 있었어!" 최고점이면 '정말 깊이 있는 감상이었어!']

=== 중요 ===
- 학생 발화 기회는 최대 ${maxTurns}번이야.
- ${maxTurns}번째 답변 뒤에는 반드시 마무리해야 해.
- 학생이 "몰라요"처럼 짧게 답해도 지금까지 한 말을 바탕으로 평가하고 마무리해.
- FEEDBACK과 NEXT_STEP_TIP은 절대 막연하면 안 돼. 반드시 학생이 실제로 한 말을 큰따옴표로 인용하고, 그 말에 빗대어 설명해야 학생이 납득할 수 있어.
- 최고점이 아니라면 NEXT_STEP_TIP에 "이렇게 말했으면 X점을 받았을 거야" 형식으로 모범 예시 문장과 그때 받을 점수를 반드시 함께 적어.
